...
VALUES
  ...
  ('b0000000-0000-0000-0000-000000000001', 'a0000000-0000-0000-0000-000000000001', 'Sun Tracker Bass Buggy 18', 'Pontoon', 8, 2022, 'Perfect family fishing pontoon with aerated livewell and folding fishing chairs.', ARRAY['Bimini top', 'Live well', 'Bluetooth audio'], ARRAY['https://images.unsplash.com/photo-1527431016772-3296dbd3b2c8?w=1200'], 65, 420, true),
  ('b0000000-0000-0000-0000-000000000002', 'a0000000-0000-0000-0000-000000000001', 'Yamaha AR250', 'Ski', 12, 2023, 'Spacious jet boat with twin engines, wakeboard tower, and premium sound system.', ARRAY['Twin engines', 'Wakeboard tower', 'Premium audio', 'Swim platform'], ARRAY['https://images.unsplash.com/photo-1559136555-9303baea8ebd?w=1200'], 135, 890, true),
  ...
  ('b0000000-0000-0000-0000-000000000004', 'a0000000-0000-0000-0000-000000000001', 'G3 Suncatcher Select 22', 'Pontoon', 11, 2021, 'Comfortable cruising pontoon with plush lounge seating and rear swim ladder.', ARRAY['Bimini top', 'Lounge seats', 'Swim ladder', 'Cooler'], ARRAY['https://images.unsplash.com/photo-1621274790572-7c32596bc67f?w=1200'], 85, 550, true),
  ('b0000000-0000-0000-0000-000000000005', 'a0000000-0000-0000-0000-000000000001', 'Bennington 23 L-Line', 'Pontoon', 13, 2023, 'Luxury pontoon boat featuring a premium layout, high-back captains chair, and under-deck lighting.', ARRAY['Premium audio', 'Under-deck lights', 'Bimini top', 'Table'], ARRAY['https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=1200'], 110, 790, true),

  -- Ozarks Cove Marina (Lake of the Ozarks) - ID: a0000000-0000-0000-0000-000000000002
  ('b0000000-0000-0000-0000-000000000006', 'a0000000-0000-0000-0000-000000000002', 'Malibu Wakesetter 23 MXZ', 'Wake', 15, 2023, 'Ultimate wakesurfing machine. Surfgate, power wedge, and customized rider presets.', ARRAY['Surf system', 'Power wedge', 'Ballast tanks', 'Premium audio'], ARRAY['https://images.unsplash.com/photo-1599582909646-2c7f6f0cf7d8?w=1200'], 220, 1400, true),
  ...
  ('b0000000-0000-0000-0000-000000000008', 'a0000000-0000-0000-0000-000000000002', 'Lund 1875 Impact XS', 'Fishing', 6, 2023, 'Versatile family fishing boat. Dual livewells, rod storage, and jump seats.', ARRAY['Dual livewells', 'Rod storage', 'Sonar', 'Bimini top'], ARRAY['https://images.unsplash.com/photo-1605910300883-8e2ae0c8d3df?w=1200'], 75, 480, true),
  ('b0000000-0000-0000-0000-000000000009', 'a0000000-0000-0000-0000-000000000002', 'Chaparral 21 SSi', 'Ski', 10, 2022, 'Sporty bowrider with canvas bimini, ski tow eye, and wrap-around windshield.', ARRAY['Bimini top', 'Ski tow eye', 'Windshield', 'Bluetooth audio'], ARRAY['https://images.unsplash.com/photo-1610641818989-575305e75b35?w=1200'], 95, 600, true),
  ...
  ('b0000000-0000-0000-0000-000000000015', 'a0000000-0000-0000-0000-000000000003', 'Trident 24 Deck Boat', 'Deck', 12, 2022, 'Versatile and fast bowrider deck boat. Ideal for day cruising and water sports.', ARRAY['Swim ladder', 'Ski locker', 'Bimini top', 'Cooler'], ARRAY['https://images.unsplash.com/photo-1540962351504-03099e0a754b?w=1200'], 115, 750, true)
ON CONFLICT (id) DO NOTHING;
